...
{
    /* Logistica > Envio */
    public function logistica_envio_pendiente_data(Request $request): JsonResponse
    {
    ...
    public function logistica_envio_pendiente_paqueteria($documento, $paqueteria): JsonResponse
    {
    ...
    public function logistica_envio_pendiente_regresar($documento, Request $request): JsonResponse
    {
        $auth = json_decode($request->auth);
    ...
    public function logistica_envio_pendiente_documento($documento, $marketplace, $zpl = 0): JsonResponse
    {
    ...
    public function logistica_envio_pendiente_guia($guia): JsonResponse
    {
    ...
    public function logistica_envio_pendiente_guardar(Request $request): JsonResponse
    {
...
//        }
    ...
    public function logistica_envio_firma_detalle($documento): JsonResponse
    {
        $informacion = DB::select("SELECT
                                    documento_entidad.razon_social AS cliente,
                                    documento.id_fase
    ...
    public function logistica_envio_firma_guardar(Request $request): JsonResponse
    {
        ignore_user_abort(true);
        set_time_limit(0);
...
//                }
    ...
    {
        return ManifiestoSalidaService::data();
    }

    public function logistica_manifiesto_manifiesto_salida_agregar(Request $request): JsonResponse
    {
        $data = $request->input("data");
        $paqueteria = $request->input("id_paqueteria");

        return ManifiestoSalidaService::agregar($data, $paqueteria);
    }

    /**
     * @throws Throwable
     */
    public function logistica_manifiesto_manifiesto_salida_imprimir(Request $request): JsonResponse
    {
        $data = json_decode($request->input("data"));

        return ManifiestoSalidaService::imprimir($data, $request);
    }

    /* Logistica > Control paqueteria */
    public function logistica_control_paqueteria_crear_data(): JsonResponse
    {
    ...
    public function logistica_control_paqueteria_crear(Request $request): JsonResponse
    {
        $data = json_decode($request->input('data'));
        $auth = json_decode($request->auth);
        $usuarios = [];
...
//        event(new PusherEvent(json_encode($notificacion)));
    ...
    public function logistica_control_paqueteria_historial_data($fecha_inicial, $fecha_final): JsonResponse
    {
    ...
    /* Logistica > guía */
    public function logistica_guia_crear_data(): JsonResponse
    {
    ...
    public function logistica_guia_crear_data_documento($documento): JsonResponse
    {
        $informacion = DB::select("SELECT
                                        documento_direccion.*,
                                        paqueteria.paqueteria,
     ...
     */
    public function logistica_guia_crear_cotizar(Request $request): JsonResponse
    {
        $data = json_decode($request->input('data'));
     ...
     */
    public function logistica_guia_crear(Request $request): JsonResponse
    {
        $data = json_decode($request->input('data'));
        $auth = json_decode($request->auth);
    ...
    /* Logistica > seguro */
    public function logistica_seguro_data(): JsonResponse
    {
    ...
    public function logistica_seguro_documento(): JsonResponse
    {
        $guias = DB::select("SELECT
                                documento.id AS id_documento,
                                documento_guia.guia,
    ...
    public function logistica_seguro_guia($guia, $total): JsonResponse
    {
     ...
     * @throws ConnectionErrorException
     */
    private function cotizar_paqueteria_raw($paqueteria, $array): string
    {
    ...
    /** @noinspection PhpUndefinedVariableInspection */
    private function cotizar_paqueteria_raw_data($data, $creador, $email): stdClass
    {
        $response = new stdClass();
    ...
    public static function manifiesto_guias_raw_data($extra_data): array
    {
    ...
    public function rawinfo_logistica_envia_cotizar(): array
    {
