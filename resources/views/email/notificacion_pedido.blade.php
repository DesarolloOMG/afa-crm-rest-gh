    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; width: 100%; max-width: 600px; margin-top: 15px;"
        ...
        <tr>
            <td align="center" bgcolor="#ffffff" style="padding: 40px 20px 40px 20px; color: #555555; font-family: Arial, sans-serif; font-size: 20px; line-height: 30px; border-bottom: 1px solid #f6f6f6;">
                ...
                <br/> ¡Muchas gracias por tu preferencia! <br><br>
                En estos momentos estamos procesando tu pedido <b>{{ $pedido }}</b> por medio de nuestro sistema.
                Durante este proceso, recibirás notificaciones informandote el estado del mismo. <br>

                Agradecemos mucho la confianza y quedamos atentos al seguimiento de tú orden. <br> <br>

                Dudas con tu vendedor con el área de ventas <br><br>
