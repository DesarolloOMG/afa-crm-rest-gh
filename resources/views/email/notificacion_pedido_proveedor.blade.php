...
<body bgcolor="#34495E" style="margin: 0; padding: 0;" yahoo="fix">
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; width: 100%; max-width: 600px; margin-top: 15px;"
        ...
        <tr>
            <td bgcolor="#ffffff" style="padding: 40px 20px 40px 20px; color: #555555; font-family: Arial, sans-serif; font-size: 20px; line-height: 30px; border-bottom: 1px solid #f6f6f6;">
                A quien corresponda,<br><br>
                
                Sirvase enviar la siguientes mercancias empacadas con la siguiente guía anexa.<br><br>

                Venta en {{ $marketplace }}: {{ $venta }}<br>
                Venta en OMG: {{ $pedido }} <br><br>

                @foreach($productos as $producto)
                <p style="margin: 0">Cantidad: <b>{{ $producto->cantidad }}</b></p>
                <p style="margin: 0">Código OMG: <b>{{ $producto->sku }}</b></p>
                <p style="margin: 0">Código CVA: <b>{{ $producto->codigo }}</b></p>
                <p style="margin: 0">Descripción: <b>{{ $producto->descripcion }}</b></p><br>
                @endforeach

                <br>

                Favor de tomar nota del <b>número de serie</b> del producto asignada al pedido para control administrativo de OMG.<br><br>
