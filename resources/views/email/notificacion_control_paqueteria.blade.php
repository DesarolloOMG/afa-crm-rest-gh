    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; width: 100%; max-width: 600px; margin-top: 15px;"
        ...
        <tr>
            <td align="center" bgcolor="#ffffff" style="padding: 40px 20px 40px 20px; color: #555555; font-family: Arial, sans-serif; font-size: 20px; line-height: 30px; border-bottom: 1px solid #f6f6f6;">
                <b>Llegó un paquete para tí</b>
                <br><br>

                Ha llegado un paquete para ti con el siguiente número de guia <b>{{ $data->guia }}</b>, puedes pasar a recoger el paquete en el área de logistica.
                <br><br>

                Información del paquete:
                <br>
                <b>Cliente:</b> {{ $data->cliente }} <br>
                <b>Contenido:</b> {{ $data->contenido }} <br>
                <b>Observaciones:</b> {{ $data->observaciones }} <br>
            </td>
        </tr>
        <tr>
